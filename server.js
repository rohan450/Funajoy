...
const express = require('express'); // Include Express to handle the server

const app = express();
const server = require('http').createServer(app); // Use HTTP server to support WebSocket
const wss = new WebSocket.Server({ server }); // Create a WebSocket server

const activeRooms = {}; // Stores all room data

// Use a simple route for the app
app.get("/", (req, res) => {
...
// Start server on the Render-provided PORT
